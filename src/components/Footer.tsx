        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/Dvikasvarma" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                <GithubLogo size={18} className="text-primary-foreground" />
              </a>
              <a href="https://www.linkedin.com/in/vikas-varma-d-55724a291" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
          ...
          <div>
            ...
            <nav className="space-y-3">
              ...
              <button onClick={() => scrollToSection('skills')} className="block text-muted-foreground hover:text-primary-glow transition-colors duration-300">
                Skills
              </button>
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-muted-foreground">
                ...
                vikasvarmadanthuluri@gmail.com
              </p>
              <p className="text-muted-foreground">
